...
//    NSString *strAddress = [NSString stringWithFormat:@"%@%@",_tableView.selectedPoi.name,_tableView.selectedPoi.address];
    NSLog(@"%@",_tableView.selectedPoi.name);
    vc.strName = _tableView.selectedPoi.name;
