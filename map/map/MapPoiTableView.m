...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        ...
        cell.textLabel.font = [UIFont systemFontOfSize:16];
//        NSString *strAddress = [NSString stringWithFormat:@"%@%@%@",point.city,point.district,point.address];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (newRow != oldRow) {
        ...
        currentCell.detailTextLabel.textColor = [UIColor blueColor];
        ...
        lastCell.detailTextLabel.textColor = [UIColor grayColor];
    }
